...
public interface TreatyDefinitionRepository extends
    ...
    @Query(value = "select td_id,td_treaty,td_wef,td_wet,td_cash_call,td_cession_rate,td_cession_rate_type,td_limit,\n" +
            "sbc.cur_iso_code cur_name ,td_status,sbu.user_username raised_by,sbu2.user_username auth_by,td_sum_insured_from, total_rows=COUNT(*) OVER()  from  sys_brk_treaty_definition\n" +
