...
public interface ClaimantDefRepo extends PagingAndSortingRepository<ClaimantsDef, Long>, QueryDslPredicateExecutor<ClaimantsDef> {
    ...
    @Query(value = "select clmnt_id,clmnt_address,clmnt_idno,clmnt_mob_no,clmnt_othernames,clmnt_surname,sbo.occ_name,sbo.occ_id,sys_brk_claimants.created_date,sbu.user_username,COUNT(*) OVER() AS total_rows \n" +
            ...
            "order by sys_brk_claimants.created_date desc OFFSET :pageNo*:limit LIMIT :limit",nativeQuery = true)
