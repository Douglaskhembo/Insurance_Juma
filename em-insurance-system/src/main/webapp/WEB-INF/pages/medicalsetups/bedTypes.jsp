...
<div class="x_panel">
    <button class="btn btn-success btn btn-info pull-right" id="btn-add-bed-types">New</button>
    <div class="x_title">
        <h4>Bed Types</h4>
    </div>
    <div class="cutom-container">
    <table id="bed-type-tbl" class="table table-hover table-bordered">
        <thead>
        <tr>
            ...
            <div class="modal-body" id="branch_model">
                <form id="bed-type-form" class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label for="unit-id" class="col-md-3 control-label">Bed Type ID</label>
                    ...
                    <div class="form-group">
                        <label for="unit-id" class="col-md-3 control-label">Bed Cost</label>
